...
test("板のURLから、データのパスと文字コードを返す", 5, function(){
...
test("2chのスレ覧をパース出来る", 1, function(){
  var url = "http://qb5.2ch.net/operate/";
  var text = "\
...
test("まちBBSのスレ覧をパース出来る", 1, function(){
  var url = "http://www.machi.to/tawara/";
  var text = "\
...
test("したらばのスレ覧をパース出来る", 1, function(){
  var url = "http://jbbs.livedoor.jp/computer/42710/";
  var text = "\
...
test("BBSPINKのスレ覧をパース出来る", 1, function(){
  var url = "http://pele.bbspink.com/erobbs/";
  var text = "\
...
test("パー速VIPのスレ覧をパース出来る", 1, function(){
  var url = "http://ex14.vip2ch.com/part4vip/";
  var text = "\
